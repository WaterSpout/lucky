...
class Race
{
     ...
     * Add wclasses
     *
     * @param \Core\LuckyBundle\Entity\Wclass $wclasses
     * @return Race
     */
    public function addWclasse(\Core\LuckyBundle\Entity\Wclass $wclasses)
    {
     ...
     * @param \Core\LuckyBundle\Entity\Wclass $wclasses
     */
    public function removeWclasse(\Core\LuckyBundle\Entity\Wclass $wclasses)
    {
